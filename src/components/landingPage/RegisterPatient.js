...
export default function Register(props) {
  ...
  return (
    <div className="bg-bgtertiary body overflow-hidden">
      <Navbar></Navbar>
      <div className="bg-secoundry w-full">
        <div className="">
          <div className=" flex justify-center mt-4">
            <h1 className="  p-2 px-8 rounded font-medium text-3xl">Register</h1>
          </div>

          <form
            className=" bg-bgtertiary font-poppins lg:ml-60  lg:px-8 lg:py-4 bg-white shadow-lg rounded max-w-screen-lg mt-8 mb-4 "
          ...
          >
            <div className="flex   mt-2 bg-bgsecondary w-fit  justify-between rounded mx-auto">
              <button
                ...
                className={
                  Toggle === "Patient"
                    ? "py-2 px-8 text-lg font-poppins font-medium cursor-pointer rounded bg-primary"
                    : "py-2 px-8 text-lg font-poppins font-medium cursor-pointer rounded bg-bgsecondary"
                }
              >
                Patient
              </button>
            ...
            >
              <h1 className="font-medium flex justify-center mt-6">
                For register as doctor contact to admin with you all information
              </h1>
              <div className="bg-transparent border-black rounded-lg border-solid border-2 p-4 mx-auto w-1/2 rounded-xl mt-8  ">
            ...
            <div className={Toggle === "Patient" ? "" : "hidden"}>
              <div className="lg:grid lg:grid-cols-4 lg:gap-2 mt-4 mr-4 grid grid-cols-4 gap-2">
                <label className="font-medium lg:text-xl font-poppins px-4 my-4 ">
                  Name
                </label>
                <div>
                  <input
                    className="bg-transparent border-black rounded-lg border-solid border-2  w-full  rounded lg:h-10 lg:pl-4 mt-4 lg:text-md text-sm h-8 px-2"
                    required
              ...
              <div className="lg:grid grid-cols-4 gap-2 mt-4 mr-4">
                <label className="font-medium lg:text-xl px-4 ">DOB</label>
                <input
                  type="date"
                  className="bg-transparent border-black rounded-lg border-solid border-2  w-full  lg:h-10 rounded pl-4 h-8"
                  required
                  value={patient.dob}
                  onChange={(e) => {
                    let temppatient = { ...patient };
              ...
              <div className="lg:grid grid-cols-4 gap-2 mt-4 mr-4">
                <label className="font-medium lg:text-xl px-4 ">
                  Mobile No.{" "}
                </label>
                ...
                <input
                  ...
                  required
                  className="bg-transparent border-black rounded-lg border-solid border-2  w-full pl-4  lg:h-10  rounded h-8"
              ...
              <div className="grid grid-cols-4 gap-2 mt-4 mr-4">
                <label className="  lg:text-xl font-medium px-4 ">Email</label>
                <input
                  type="email"
                  id="email"
                  placeholder="e.g : abcdefg@gmail.com"
                  required
                  className="bg-transparent border-black rounded-lg border-solid border-2  w-full  lg:h-10 rounded pl-4 col-span-2 h-8"
                  value={patient.email}
                  onChange={(e) => {
                    let temppatient = { ...patient };
              ...
              <div className="grid grid-cols-4 gap-2 mt-4 mr-4">
                <label className="  lg:text-xl font-medium px-4">
                  Blood Group
                </label>
                <div className="">
                  <select
                    className="pl-4 lg:w-1/2  lg:h-10  rounded  h-8"
                    id="blood-group"
              ...
              <div className="grid grid-cols-4 gap-2 mt-4 mr-4 grid-flow-dense ">
                <label className=" lg:text-xl font-medium px-4 mb-8 col-span-1">
                  Address
                </label>
              ...
              <div className="lg:grid grid-cols-4 gap-2 mt-4 mr-4">
                <label type="password" className="  lg:text-xl font-medium px-4">
                  Password
                </label>
                <input
                  type="password"
              ...
              <div className="lg:grid lg:grid-cols-4 gap-2 mt-4 mr-4 flex">
                ...
                <input
                  type="password"
                  id="password"
                  className="bg-transparent border-black rounded-lg border-solid border-2  w-full  lg:h-10  rounded lg:pl-4 h-8 pl-2"
                  required
              ...
              <div className="lg:grid lg:grid-cols-10 gap-2 mt-8 mr-4">
                <div className="col-span-5">
                  <label className=" lg:text-xl font-medium px-4 grid col-start-1 col-span-3">
                ...
                <div className="col-span-4">
                  {diseaseList.map((disease, index) => {
                    return (
                      ...
                      >
                        <input
                          className="bg-transparent border-black rounded-lg border-solid border-2  w-full  lg:h-10 col-span-3 rounded lg:pl-4 h-8 pl-2"
                          type="text"
                          name="disease"
                        ...
                        />
                        <input
                          className="bg-transparent border-black rounded-lg border-solid border-2  w-full  lg:h-10 col-span-3  rounded lg:pl-4 h-8 pl-2 ml-4"
                          type="text"
                          name="yrs"
            ...
            <div className={Toggle === "Patient" ? "" : "hidden"}>
              <div className="flex justify-center">
                <h1 className=" p-4 rounded font-medium lg:text-3xl text-xl mt-2">
                  Emergency Contact Details
                </h1>
              </div>

              <div className="lg:grid grid-cols-4 gap-2 mt-8 mr-4 flex">
                <label className="font-medium lg:text-xl px-4 ">Name</label>
                <input
                  className="bg-transparent border-black rounded-lg border-solid border-2  w-full  rounded h-10 pl-4"
                  placeholder="first name"
              ...
              <div className="mt-4">
                <label className=" rounded p-2 lg:text-xl font-medium px-4">
                  Relation with patient
                </label>
                <input
                  className="bg-transparent border-black rounded-lg border-solid border-2  w-full  lg:h-10 ml-24 rounded pl-4 h-8 lg:mt-0 lg:ml-0 mt-2 "
              ...
              <div className="grid grid-cols-4 gap-2 mt-4 mr-4 grid-flow-dense ">
                ...
                <div className="grid grid-cols-2 gap-8 col-span-3 ">
                  <input
                    type="text"
                    className="bg-transparent border-black rounded-lg border-solid border-2  w-full  h-10  rounded pl-4 "
                    required
                    placeholder="building/area"
              ...
              <div className="flex justify-center mb-4 mt-8">
                {Loading ? (
                  ...
                  <button className="bg-primary rounded p-2 px-8 font-medium text-xl hover:bg-bgsecondary mb-4 ">
                    Submit
                  </button>
                )}
              </div>
