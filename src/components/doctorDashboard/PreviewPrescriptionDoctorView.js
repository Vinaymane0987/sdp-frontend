      ...
      <div className="w-3/4  ml-32 bg-white shadow-xl p-8 mb-4 mt-6">
        <div className="grid grid-cols-2 border-b-2 border-black">
          <div className="m-2 ">
            ...
            <div className="flex">
              <h2 className="font-light">Mobile No.</h2>
              <h2 className="ml-2">{prescription.doctormobile}</h2>
            </div>
          </div>
          <div className="m-2 ">
            <div>
              <h1 className="font-light">{prescription.hospital.name}</h1>
            </div>
            <div className="flex">
            ...
            <div className="flex">
              <h2 className="font-light">Phone no.</h2>
              <h2 className="ml-2">{prescription.hospital.mobile}</h2>
            </div>
            {/* <div className="flex">
              <h2 className="font-light">Closed :</h2>
        ...
        <div className="grid grid-cols-3 mt-4">
          <div className="col-span-2">
            <div className="flex">
              <h1 className="font-light">Health ID : </h1>
              <h4 className="ml-2">{props.healthID}</h4>
            </div>
            <div className="flex">
              <h1 className="font-light">Patient Name : </h1>
              <div className="flex">
            ...
            <div className="flex">
              <h1 className="font-light mr-2">Address: </h1>
        ...
        {/* <div className="flex">
          <h1 className="font-light">Referred by :</h1>
        ...
        <div className="grid grid-rows-2 mt-4 ">
          <div className="grid grid-cols-2 justify-center border-t-2 border-b-2 border-black ">
            <h1 className="ml-2 font-light">Chief complaints</h1>
            <h1 className="ml-2 font-light">clinincal findings</h1>
          </div>
        ...
        <div className="mt-2">
          <h1 className="font-light">Notes </h1>
          <h4 className="ml-2">{prescription.notes}</h4>
        </div>
        <div className="mt-2">
          <h1 className="font-light">Diagnosis</h1>
          <h4 className="ml-2">{prescription.diagnosis}</h4>
        </div>
        <div className="">
          <h1 className="font-light">Procedure Conducted</h1>
          <h4 className="ml-2">{prescription.procedureConducted}</h4>
        </div>
        <div className="mt-4">
          <div className="grid grid-cols-3 border-b-2 border-t-2 border-black">
            <h1 className="font-light">medicine name</h1>
            <h1 className="font-light">Dosages</h1>
            <h1 className="font-light">Duration</h1>
          </div>
        ...
        <div className="mt-4">
          <h1 className="font-light">Insvestigations</h1>
          <div>
        ...
        <div className="mb-2">
          <h1 className="font-light">Advices</h1>
          <div>
