    ...
    <div className="font-poppins col-span-10 overflow-y-scroll">
      <div className=" lg:min-h-screen lg:grid grid-cols-6  ">
        <div className=" col-start-1 col-span-6 ml-8">
          <h3 className="font-light lg:text-2xl my-6 ml-6  ">
            Add a New Diagnosis
          </h3>

          <form
            className="bg-white shadow p-6 m-2 ml-2 mt-8 lg:font-light  "
            onSubmit={handleAddPrescription}
          >
            <div className="mt-3">
              {chiefComplaints.map((chiefComplaint, index) => (
                <div className="grid grid-cols-6 mt-2">
                  <h3 className="col-span-1">Chief Complaints </h3>
                  ...
                  <input
                    ...
                    className="   bg-transparent border-black rounded-lg border-solid border-2 p-2"
                  ></input>
                  <input
            ...
            <div className="grid grid-cols-6 mt-3  ">
              <h3 className="col-span-1">Procedure Conducted</h3>
            ...
            <h3 className="font-light text-xl mt-4 ">Medicines</h3>
                ...
                <div>
                  <div className="grid grid-cols-8">
                    <div className="col-span-3">
                      <div className="grid grid-cols-6 mt-2  ">
                        <h3 className="col-span-2">Medicine Name </h3>

                        <input
                          placeholder="Medicine Name"
                          required
                          className="  rounded mx-2 px-2 py-1.5 outline-none col-span-4 ml-14 bg-transparent border-black rounded-lg border-solid border-2 p-2"
                      ...
                      <div className="grid grid-cols-6 mt-3  ">
                        ...
                        <input
                          ...
                          className="  rounded mx-2 px-2 py-1.5 outline-none ml-14 col-span-4"
                          value={medicine.type}
                          onChange={(e) => {
                            let tempmedicinelist = [...MedicineList];
                      ...
                      <div className="grid grid-cols-6 mt-3  ">
                        <h3 className="col-span-2">Duration (days)</h3>
                      ...
                      <div className="grid grid-cols-6 mt-3  ">
                        <h3 className="col-span-2">Total Tablets</h3>
                    ...
                    <div className="col-span-3 ml-6">
                      <h3>Dosages</h3>
                      <div className="grid grid-cols-6 mt-3  ">
                        <h3 className=" col-span-2">Morning</h3>
                      ...
                      <div className="grid grid-cols-6 mt-2  ">
                        <h3 className="col-span-2">Afternoon</h3>
                      ...
                      <div className="grid grid-cols-6 mt-2  ">
                        <h3 className="col-span-2">Night</h3>
            ...
            <div>
              {investigations.map((Investigation, index) => (
                <div className="grid grid-cols-6 mt-6">
                  <h3 className="col-span-1">Investigations </h3>
              ...
              {advices.map((Advice, index) => (
                <div className="grid grid-cols-6 mt-2">
                  <h3 className="col-span-1">Advices </h3>
            ...
            <div className="flex justify-center mt-8">
              {Loading ? (
                ...
                <button className="bg-primary rounded p-2 px-8 font-light text-xl hover:bg-bgsecondary mb-4 ">
                  Submit
                </button>
              )}
            </div>
