  ...
  return (
    <div className="col-span-10">
      {props.healthID.length === 12 ? (
              ...
              <Link to="/doctor/profile">
                <div className="flex bg-white rounded shadow  px-4   ml-auto h-14 w-1/5 mr-8 mt-8">
                  ...
                  <div className="grid grid-rows-2 ml-4 gap-2  mb-4">
                    <div className="font-light font-poppins text-base flex my-2">
                      <h1>Dr.</h1>
                      <h1 className="ml-2">
              ...
              <div className="bg-white m-4 rounded-lg ">
                <div className="grid grid-rows-2 p-6 gap-2 shadow">
                  ...
                  {prescriptions.length > 0 ? (
                    ...
                    <div className="font-light mt-3 mx-auto">
                      No Record Found...
                    </div>
                  )}
                </div>
        ...
        <div className="text-xl flex justify-center items-center font-light my-80 py-4 flex-col ">
