    ...
    <div className="h-screen overflow-y-hidden w-screen grid grid-cols-12">
      <div className="side_bar bg-white shadow col-span-2">
        <div className="flex m-2 mt-4  ">
          ...
          <div className="heading font-poppins font-medium">
            <Link to="/">
              <h5>Public health Record System</h5>
            </Link>
          </div>
        </div>
        <nav>
          ...
          >
            <div className="flex m-2 mt-8 ">
              ...
              <div className="font-poppins font-medium ml-4">
                <h2>Dashboard</h2>
              </div>
            </div>
          </Link>
          ...
          <div className="p-4">
            <h1 className="font-poppins font-medium text-xl mt-4">Main menu</h1>
            <div className="grid grid-rows-2  font-medium font-poppins mt-4">
              <Link
        ...
        <div className=" mx-auto mt-56 py-1    bg-primary  rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary w-2/5  ">
          <button className="font-medium  flex items-center" onClick={logout}>
