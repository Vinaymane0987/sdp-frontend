      ...
      <div class="bg-secoundry">
        <div class="">
          <div class=" flex justify-center mt-4">
            <h2 class="  p-2 px-8 rounded font-medium text-4xl">Register</h2>
          </div>
          ...
          >
            <div class="flex   mt-2 bg-bgsecondary w-fit  justify-between rounded mx-auto">
              <h1
                className={
                  "py-2 px-8 text-lg font-poppins font-light cursor-text rounded bg-primary"
                }
              >
                Doctor
              </h1>
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="font-medium text-base font-poppins px-4 my-4 ">
                Doctor Name
              </label>
              <input
                class="bg-transparent border-black rounded-lg border-solid border-2  rounded h-10 pl-4 mt-4"
                required
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="font-medium text-base px-4 ">Birthdate</label>
              <input
                type="date"
                class=" bg-transparent border-black rounded-lg border-solid border-2  h-10 rounded pl-4"
                required
                value={doctor.dob}
                onChange={(e) => {
                  let tempdoctor = { ...doctor };
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="font-medium text-base px-4 ">Mobile No. </label>

              <input
                type="tel"
                placeholder="mobile no."
                required
                class="bg-transparent border-black rounded-lg border-solid border-2 pl-4  h-10  rounded"
                value={doctor.mobile}
                onChange={(e) => {
                  let tempdoctor = { ...doctor };
            ...
            <div class=" aadhar grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="font-medium text-base px-4 ">Aadhar Card No. </label>
            ...
            <div class="grid grid-cols-4 mt-4 mr-4">
              <label class="font-medium text-base px-4">
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="  text-base font-medium px-4">Email</label>
              <input
                type="email"
                id="email"
                placeholder="abcd@gmail.com"
                required
                class="bg-transparent border-black rounded-lg border-solid border-2  h-10 rounded pl-4 col-span-2 "
                value={doctor.email}
                onChange={(e) => {
                  let tempdoctor = { ...doctor };
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="  text-base font-medium px-4">Blood Group</label>
              <div className="">
                <select
                  className="pl-4 w-1/2  h-10  rounded "
                  id="blood-group"
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4 grid-flow-dense ">
              <label class=" text-base font-medium px-4 mb-8 col-span-1">
                Address
              </label>
              <div className="grid grid-cols-2 gap-4 col-span-3 ">
                ...
                <input
                  type="number"
                  className="bg-transparent border-black rounded-lg border-solid border-2  h-10  rounded  pl-4"
                  required
            ...
            <div class="grid grid-cols-4 gap-2 mt-8 mr-4">
              <label class=" text-base font-medium px-4 grid col-start-1 col-span-1">
                Education
              </label>
              <div className=" ">
                {EducationList.map((Education, index) => (
                  <div className=" flex " key={index} id="degree">
                    <input
                      class="bg-transparent border-black rounded-lg border-solid border-2  h-10  rounded mb-8 pl-4 grid col-start-2 col-span-1  "
                      placeholder="eg. MBBS"
                      id="degree"
                      name="degree"
              ...
              <div className=" ">
                {SpecialityList.map((Special, index) => (
                  <div className=" flex " key={index} id="speciality">
                    <input
                      className="bg-transparent border-black rounded-lg border-solid border-2  h-10  rounded mb-8 pl-4 grid col-start-3 col-span-1"
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="  text-base font-medium px-4">Hospital Name</label>
              <input
                type="text"
                id="hospital-name"
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label class="  text-base font-medium px-4">
                Hospital Contact No.
              </label>
              <input
                type="tel"
            ...
            <div class="grid grid-cols-4 gap-2 mt-4 mr-4">
              <label type="password" class="  text-base font-medium px-4">
                Password
              </label>
              <input
                type="password"
