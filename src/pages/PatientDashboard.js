        ...
        <div className=" main ">
              ...
              <Link to="/patient/profile">
                <button className="flex bg-white rounded shadow  px-4  ml-60 h-14 ">
                  <img
                    ...
                    alt="profile"
                  ></img>
                  <div className="mt-4 ml-4  font-light font-poppins">
          ...
          <div className="grid grid-cols-2">
            <div className="m-4 p-4">
              <div>
                <h1 className="font-light font-poppins text-xl ">
                  Patient Details
                </h1>
              </div>
              <div className="bg-white font-poppins p-4 mt-4 px-8 rounded-xl shadow">
                ...
                <div>
                  <h1 className="font-light mt-4">Past Health History</h1>
            ...
            <div className="m-4 p-4 ">
              ...
              {prescriptions.length > 0 ? (
                ...
                <div className="bg-white mt-4 font-poppins p-4 rounded-xl shadow px-8 flex justify-center font-light">
                  {" "}
                  No Data Found...{" "}
                </div>
              )}
          ...
          <div className="font-poppins m-4  ">
            <div className="flex justify-between m-8">
              <div className="font-light text-xl ml-4">
                <h1>Patient Dashboard</h1>
              </div>
            </div>
            <div className="bg-white m-4 rounded-lg ">
              <div className="grid grid-rows-2 p-6 gap-2 shadow">
                <div className="grid grid-cols-4 font-light  ">
                  <div>
                    <h1>Date</h1>
                  </div>
                  <div>
                        ...
                        >
                          <div className=" flex  justify-center bg-primary py-1 px-3 rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary w-2/5   ">
                            <img
                              ...
                              alt="preview"
                            ></img>
                            <button className="font-light ml-2">Preview </button>
                          </div>
                        </Link>
                      </div>
                    );
