        ...
        <div className="main    m-2  ">
          ...
          <div className="">
            <div className="flex  h-12 m-2 bg-bgprimary rounded mt-4 ">
              <div>
                <h2 className="text-2xl font-poppins font-light p-2 ">
                  DashBoard Today
                </h2>
              </div>
              ...
              <Link to="/doctor/profile">
                <div className="flex bg-white rounded shadow  px-4  ml-60 h-14 ">
                  ...
                  <div className="grid grid-rows-2 ml-4 gap-2  mb-4">
                    <div className="font-medium font-poppins text-base">
                      <h1 className="">
          ...
          >
            <div className="grid col-start-1 col-span-3">
              <h3 className="text-xl font-poppins font-light p-2 ">
            ...
            {Loading ? (
              ...
              <div className=" grid col-start-8  h-10 ml-4  bg-primary  rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary  ">
                <div className="flex py-2 px-4 items-center ">
                  ...
                  <button className="ml-2 flex  rounded font-light font-poppins shadow-sm hover:bg-bgsecondary   ">
                    Search
                  </button>
                </div>
              </div>
            ...
            <div className="grid col-start-9  h-10 ml-4  bg-primary  rounded font-semibold font-poppins shadow-sm hover:bg-bgsecondary  ">
              <div className="flex py-2 px-4 items-center ">
                <div
                  className="ml-2 flex cursor-pointer rounded font-light font-poppins shadow-sm hover:bg-bgsecondary "
                  onClick={() => {
                    props.setHealthID("");
                  }}
                >
          ...
          {Object.keys(patient).length !== 0 ? (
            <div className="grid grid-cols-2">
              <div className="m-4 p-4">
                ...
                <div className="bg-white font-poppins p-4 mt-4 px-8 rounded-xl shadow">
                  ...
                  <div>
                    <h1 className="font-medium mt-4">Past Health History</h1>
              ...
              <div className="m-4 p-4 ">
                ...
                {prescriptions.length > 0 ? (
                  ...
                  <div className="bg-white mt-4 font-poppins p-4 rounded-xl shadow px-8 flex justify-center font-medium">
                    {" "}
                    No Data Found...{" "}
                  </div>
                )}
            ...
            <div className="text-xl flex justify-center items-center font-medium my-60">
            ...
            <div className="font-poppins m-4  ">
              ...
              <div className="bg-white m-4 rounded-lg ">
                <div className="grid grid-rows-2 p-6 gap-2 shadow">
                  <div className="grid grid-cols-4 font-medium  border-b-2">
                    <div>
                      <h1>Date</h1>
                    </div>
                    <div>
